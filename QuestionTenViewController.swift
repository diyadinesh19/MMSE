//
//  QuestionTenViewController.swift
//  MMSEApp
//
...
class QuestionTenViewController: UIViewController {
    var ans = false;
    ...
    @IBAction func submitAnswer(_ sender: Any) {
        ...
        let navC = storyboard?.instantiateViewController(identifier: "question11") as! QuestionElevenViewController
