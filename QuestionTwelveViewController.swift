//
//  QuestionTwelveViewController.swift
//  MMSEApp
//
...
class QuestionTwelveViewController: UIViewController {
    var ans = false;
    ...
    @IBAction func submitAnswer(_ sender: Any) {
        ...
        let navC = storyboard?.instantiateViewController(identifier: "results") as! ResultsViewController
