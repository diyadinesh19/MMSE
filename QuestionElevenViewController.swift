//
//  QuestionElevenViewController.swift
//  MMSEApp
//
...
class QuestionElevenViewController: UIViewController {
    var ans = false;
    ...
    @IBAction func submitAnswer(_ sender: Any) {
        ...
        let navC = storyboard?.instantiateViewController(identifier: "question12") as! QuestionTwelveViewController
